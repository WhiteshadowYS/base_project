...
class _$TokenTearOff {
  ...
  _Token call({@JsonKey(name: 'token') required String token}) {
    return _Token(
      token: token,
    );
  }
...
class _$_Token extends _Token {
  const _$_Token({@JsonKey(name: 'token') required this.token}) : super._();
...
abstract class _Token extends Token {
  const factory _Token({@JsonKey(name: 'token') required String token}) =
      _$_Token;
